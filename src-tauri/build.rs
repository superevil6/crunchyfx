// CrunchySFX ships as index.html + presets.js + dsp.js + synth.js + styles.css at the repo root — the
// SAME files the web version serves. Tauri wants a frontend directory, so before compiling we copy them
